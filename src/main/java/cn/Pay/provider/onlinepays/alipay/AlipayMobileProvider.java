...
@Pay(name="手机支付宝即时到账")
@Service
public class AlipayMobileProvider implements IOnlinePayProvider {
	...
	public PayResult Pay(PayParamEntity param) {
		...
		try {
			...
			alipayRequest.setReturnUrl(siteInfo.getSiteUrl()+"/pay/result/alipayWapPay");
			alipayRequest.setNotifyUrl(siteInfo.getSiteUrl()+"/pay/notify/alipayWapPay");
